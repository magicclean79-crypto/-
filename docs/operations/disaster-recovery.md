# Disaster Recovery (TASK-1601 · TASK-1701, Sprint 16~17)
...
| `BACKUP_RPO_HOURS` | 허용 최대 손실 구간 | 24 |
...
### 이미지 저장소 보호 (CTO 결정 1601-④)

**애플리케이션은 이미지를 백업하지 않습니다.** 저장소의 버전 관리·복제 상태를
읽어 체크리스트에 표시만 합니다. 저장소가 알려 주지 않으면 `직접 확인`으로
남습니다 — 확인하지 못한 것을 "꺼짐"이나 "정상"으로 단정하지 않습니다.
