...
export const LIVING_GOODS_TEMPLATE_CATALOG: TemplateCatalogEntry[] = [
  {
    key: "living-a-trust",
    name: "A — 신뢰/근거형",
    description: "구매포인트 → Hero → 특징(증거 사진) → 스펙 체크리스트 순으로 근거를 쌓는 구성.",
    traits: [
      { label: "Hero", value: "사진 위 텍스트 오버레이" },
  ...
  },
  {
    key: "living-b-mood",
    name: "B — 감성/무드형",
    description: "오버레이 없는 풀블리드 무드 Hero → 설명 먼저 → 구매포인트(아웃라인) 순.",
    traits: [
      { label: "Hero", value: "풀블리드, 텍스트 없음" },
  ...
  },
  {
    key: "living-c-value",
    name: "C — 즉시구매/가격강조형",
    description: "구매포인트(가격 배지 스타일)를 Hero보다 먼저 배치, 특징은 2열 그리드로 촘촘하게.",
    traits: [
      { label: "Hero", value: "작고 컴팩트" },
  ...
  },
  {
    key: "living-d-proof",
    name: "D — 기능증명형",
    description: "Hero·특징 카드 모두 대형 사진으로 기능이 실제로 작동한다는 증거를 강조.",
    traits: [
      { label: "Hero", value: "대형 액션샷" },
